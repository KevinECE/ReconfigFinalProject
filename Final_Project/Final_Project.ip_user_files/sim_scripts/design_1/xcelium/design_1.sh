...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../Final_Project.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Final_Project.gen/sources_1/bd/design_1/ipshared/f42d/hdl" \
       +incdir+"../../../../Final_Project.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../Final_Project.gen/sources_1/bd/design_1/ipshared/f42d/hdl" \
